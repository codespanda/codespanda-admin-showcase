...
const BLOG_POSTS = [
  ...
  { slug: "state-management-when-you-need-redux", title: "State Management in 2026: When You Actually Need Redux (and When You Don't)", desc: "Every admin panel eventually asks the state-management question. Most of the time the honest answer is: you already have everything you need." },
